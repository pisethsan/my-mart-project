...
const categories = ref([
  {
    name: 'Fruits',
    items: [
      { id: 101, name: 'ប័រ', price: 3.75, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/RVPZNXbh/avocados.jpg', description: '' },
      { id: 102, name: 'ផាសិន', price: 3.00, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/L4tTKZQq/passion.jpg', description: '' },
      { id: 103, name: 'មើមយ៉េន', price: 2.00, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/D0p3yYf5/beetroot.jpg', description: '' },
      { id: 104, name: 'ឪឡឹកលឿង', price: 1.00, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/15yK95bb/Yellow_Watermelon.jpg', description: '' },
      { id: 105, name: 'ឪឡឹកក្រហម', price: 0.50, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/qMpGkMWx/Red_Watermelon.jpg', description: '' },
      { id: 106, name: 'ស្រកានាគស', price: 1.75, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/L5p3gH53/dragon_fruit.jpg', description: '' },
      { id: 107, name: 'ល្ហុងហូលែន', price: 1.25, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/br9HQKS7/papaya.jpg', description: '' },
      { id: 108, name: 'ត្របែកអត់គ្រាប់', price: 2.00, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/tC9zXC8L/Seedless_guava.jpg', description: '' },
      { id: 109, name: 'ត្របែកគីមជូ', price: 2.00, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/prJYDg58/guavas_kimjo.jpg', description: '' },
    ]
  },
  {
    name: 'Vegetables',
    items: [
      { id: 201, name: 'ការ៉ុត', price: 2.00, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/mkyNQ01Q/carrot.jpg', description: '' },
      { id: 202, name: 'ដំឡូងបារាំង', price: 2.00, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/QNQbGWYF/Potatoes.jpg', description: '' },
      { id: 203, name: 'ដំឡូងជ្វាជប៉ុន', price: 2.00, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/wMQchSRP/Japanese_sweet_potatoes.jpg', description: '' },
      { id: 204, name: 'ខ្ទឹមបារាំងស្វាយ', price: 2.00, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/jqHX0J36/Red_onions.jpg', description: '' },
      { id: 205, name: 'ខ្ទឹមបារាំង', price: 2.00, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/ncn1HcNS/Yellow_onion.jpg', description: '' },
      { id: 206, name: 'ស្ពៃក្ដោប', price: 2.00, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/65xmCXgm/cabbage.jpg', description: '' },
      { id: 207, name: 'ស្ពៃបូកគោ', price: 2.00, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/mZYwfFpg/Napa_cabbage.jpg', description: '' },
    ]
  },
  {
    name: 'Fresh Meat',
    items: [
      { id: 301, name: 'មាន់ស្រែ', price: 7.25, unit: 'គីឡូក្រាម', imageUrl: 'https://i.postimg.cc/nrGYv69Y/Farm_chicken.jpg', description: '' },
    ]
  },
  {
    name: 'Soap Washing',
    items: [
      { id: 401, name: 'សាប៊ូបោកខោអាវ 1clean blue', price: 2.50, unit: 'ដប', imageUrl: 'https://i.postimg.cc/d3RVHgCc/1Clean_Laundry_Detergent_Blue.jpg', description: '' },
      { id: 402, name: 'សាប៊ូបោកខោអាវ 1clean pink', price: 2.50, unit: 'ដប', imageUrl: 'https://i.postimg.cc/598y2QR6/1Clean_Laundry_Detergent_Pink.jpg', description: '' },
      { id: 403, name: 'សាប៊ូបោកខោអាវ 1clean red', price: 2.50, unit: 'ដប', imageUrl: 'https://i.postimg.cc/G3vtmT5y/1Clean_Laundry_Detergent_Red.jpg', description: '' },
      { id: 404, name: 'ទឹកក្រអូប 1clean', price: 3.00, unit: 'ដប', imageUrl: 'https://i.postimg.cc/gjb0KGnv/1Clean_Fragrant_Water_Blue.jpg', description: '' },
      { id: 405, name: 'ទឹកក្រអូប 1clean', price: 8.00, unit: 'ដប', imageUrl: 'https://i.postimg.cc/L5k8CG1N/1Clean_Fragrant_Water_Purple.jpg', description: '' },
      { id: 406, name: 'សាប៊ូលាងចាន 1clean', price: 0.65, unit: 'ដប', imageUrl: 'https://i.postimg.cc/FzXKxh7J/1Clean_Dish_Soap.jpg', description: '' },
      { id: 407, name: 'ទឹកលាងចាន​ 1clean green', price: 0.65, unit: 'ដប', imageUrl: 'https://i.postimg.cc/PJnqMdPW/1Clean_Dishwashing_Liquid_Green.jpg', description: '' },
      { id: 408, name: 'ទឹកលាងចាន​ 1clean', price: 0.65, unit: 'ដប', imageUrl: 'https://i.postimg.cc/sxC2J3v7/1Clean_Dishwashing_Liquid_White.jpg', description: '' },
      { id: 409, name: 'សាប៊ូបោកខោអាវ Ora', price: 1.75, unit: 'កញ្ជប់', imageUrl: 'https://i.postimg.cc/h4VvtQ5r/Ora_Laundry_Detergent.jpg', description: '' },
      { id: 410, name: 'ទឹកក្រអូប Ora', price: 2.50, unit: 'ដប', imageUrl: 'https://i.postimg.cc/L4j58gbj/Ora_Fragrant_Water.jpg', description: '' },
      { id: 411, name: 'សាប៊ូ លាងចាន Ora', price: 0.65, unit: 'ដប', imageUrl: 'https://i.postimg.cc/wxDMjRGk/Ora_Dish_Soap.jpg', description: '' },
      { id: 412, name: 'ទឹកលាងបង្គន់​​ Ora', price: 1.5, unit: 'ដប', imageUrl: 'https://i.postimg.cc/CMb5xnQm/Ora_Toilet_Water.jpg', description: '' },
    ]
  },
  {
    name: 'Soap Skin and Hair Care',
    items: [
      { id: 413, name: 'សាប៊ូ អង្ករផា្កម្លិះខ្មែរ', price: 4.00, unit: 'ដប', imageUrl: 'https://i.postimg.cc/k5X12FBj/Jammine_Rice_And_Coconut_Shampoo.jpg', description: '' },
      { id: 414, name: 'សាប៊ូដុខ្លួនម្នាស់', price: 2.50, unit: 'ដប', imageUrl: 'https://i.postimg.cc/cJ49vMrk/Kavi_Body_Soap.jpg', description: '' },
      { id: 415, name: 'សាប៊ូកក់សក់ខ្មែរ ធម្មជាតិ', price: 4.00, unit: 'ដប', imageUrl: 'https://i.postimg.cc/pdXGmYp6/Khmer_Organic_Shampoo.jpg', description: '' },
      { id: 416, name: 'សាប៊ូកក់សក់ klen', price: 3.50, unit: 'ដប', imageUrl: 'https://i.postimg.cc/7LYs5MfX/Klen_Shampoo.jpg', description: '' },
      { id: 417, name: 'សាប៊ូកក់សក់ស្ពៃ ', price: 3.00, unit: 'ដប', imageUrl: 'https://i.postimg.cc/wBTf1c7s/Empress_Shampoo.jpg', description: '' },
      { id: 418, name: 'សាប៊ូដុសខ្លួនស្ពៃ', price: 3.00, unit: 'ដប', imageUrl: 'https://i.postimg.cc/Xv7Hrcpp/Empress_Body_Soap.jpg', description: '' },
      { id: 419, name: 'សាប៊ូលាងមុខស្ពៃ', price: 3.00, unit: 'ដប', imageUrl: 'https://i.postimg.cc/s2D6M9vB/Empress_Face_Wash.jpg', description: '' },
      { id: 420, name: 'សាប៊ូដុសមុខស្ពៃ', price: 3.00, unit: 'ដុំ', imageUrl: 'https://i.postimg.cc/q7MbNXzN/Empress_Facial_soap.jpg', description: '' },
    ]
  },
  {
    name: 'Herbs',
    items: [
      { id: 501, name: 'ប្រេងកូឡា​ល្ងខ្មៅ', price: 7.25, unit: 'ដប', imageUrl: 'https://i.postimg.cc/mg9Vkw7t/Black_Sesame_Cola_oil.jpg', description: 'ប្រេងកូឡា​ល្ងខ្មៅ​ 15g=4000, 30g=8000, 60g=10000' },
      { id: 502, name: 'ប្រេងកូឡា​ប្រទាលម្រុំ​', price: 7.25, unit: 'ដប', imageUrl: 'https://i.postimg.cc/tRSHNXw2/Balsam-Cola-oil.jpg', description: 'ប្រេងកូឡា​ប្រទាលម្រុំ​ 15g=4000, 30g=8000, 60g=10000' },
      { id: 503, name: 'ប្រេងខ្យល់ពន្លៃ ម្រុំ', price: 7.25, unit: 'ដប', imageUrl: 'https://i.postimg.cc/cL3TCmf1/Ginger_and_Moringa_oil.jpg', description: 'ប្រេងខ្យល់ពន្លៃ ម្រុំ ដបតូច=7000, ដបធំ=15000' },
      { id: 504, name: 'ប្រេងខ្យង់យិនស៊ិន', price: 7.25, unit: 'ដប', imageUrl: 'https://i.postimg.cc/152JyTVm/Ginseng_oil.jpg', description: 'ប្រេងខ្យង់យិនស៊ិន ដបតូច=7000, ដបធំ=15000' },
    ]
  },
  {
    name: 'Spices',
